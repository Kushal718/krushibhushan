                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-3 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="placeholderInput" placeholder="Enter Title" name="title" value="Grow Naturally Live Natural"  required>
                                    </div>
                                </div>
                                <div class="col-xxl-3 col-md-4">
                                    <div>
                                        <label for="placeholderInput" class="form-label">SubTitle</label>
                                        <input type="text" class="form-control" id="placeholderInput" placeholder="Enter SubTitle" name="subtitle" value="Agriculture is the science and art of cultivating plants and livestock"   required>
                                    </div>
                                </div>
